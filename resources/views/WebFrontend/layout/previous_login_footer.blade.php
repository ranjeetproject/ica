        ...
        <div class="social-wrap">
            ...
            <div class="footer-quick-links">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="{{action('CmsController@aboutUs')}}"><img src="{{asset('css/images/footer-arrow.png')}}"> About Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{action('CmsController@contactUs')}}"><img src="{{asset('css/images/footer-arrow.png')}}"> Contact Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{action('CmsController@termsAndCondition')}}"><img src="{{asset('css/images/footer-arrow.png')}}"> Terms &
                            Conditions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{action('CmsController@privacyPolicy')}}"><img src="{{asset('css/images/footer-arrow.png')}}"> Privacy Policy</a>
                    </li>
                </ul>
            </div>
