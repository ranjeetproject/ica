<div class="questionBlock">
    ...
    <div class="qbSelect">
        <div class="qbSelectB">
            ...
            <select class="form-select" aria-label="Default select example" name="accounting2PrimaryAccount_{{$question->id}}" id="accounting2PrimaryAccount_{{$question->id}}">
        ...
        <div class="qbSelectB">
            ...
            <select class="form-select" aria-label="Default select example" name="accounting2SecondaryAccount_{{$question->id}}" id="accounting2SecondaryAccount_{{$question->id}}">
                <option selected value=''>Select</option>
        ...
        <div class="qbSelectB">
            ...
            <select class="form-select" aria-label="Default select example" name="accounting2AccountName_{{$question->id}}" id="accounting2AccountName_{{$question->id}}">
        ...
        <div class="qbSelectB">
            <label>Amount</label>
            <input class="form-control" type="number" placeholder="Default input" aria-label="default input example" name="accounting2Amount_{{$question->id}}" id="accounting2Amount_{{$question->id}}" />
        </div>
    ...
    <div class="qInner qBtnB">
        <div class="qbLft">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="accounting2DebitCredit_{{$question->id}}" id="accounting2DebitCreditDebit_{{$question->id}}" value="0" checked>
                <label class="form-check-label" for="accounting2DebitCreditDebit_{{$question->id}}">Debit</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="accounting2DebitCredit_{{$question->id}}" id="accounting2DebitCreditCredit_{{$question->id}}" value="1">
