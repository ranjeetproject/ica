                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="carousel-indicators">
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="numberIcn" aria-current="true" id="numberIcnButton_1" aria-label="Slide 1"><span data-bs-dismiss="modal">1</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_2" aria-label="Slide 2"><span data-bs-dismiss="modal">2</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_3" aria-label="Slide 3"><span data-bs-dismiss="modal">3</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_4" aria-label="Slide 4"><span data-bs-dismiss="modal">4</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="4" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_5" aria-label="Slide 5"><span data-bs-dismiss="modal">5</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="5" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_6" aria-label="Slide 6"><span data-bs-dismiss="modal">6</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="6" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_7" aria-label="Slide 7"><span data-bs-dismiss="modal">7</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="7" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_8" aria-label="Slide 8"><span data-bs-dismiss="modal">8</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="8" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_9" aria-label="Slide 9">
                                    <span data-bs-dismiss="modal">9</span></button>
                                <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="9" data-bs-dismiss="modal" class="numberIcn" id="numberIcnButton_10" aria-label="Slide 10"><span data-bs-dismiss="modal">10</span></button>
                            </div>
                        </div>
                    </div>
                </div>
